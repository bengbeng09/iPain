/*
This class provides the functionality for the login screen.
It also checks the user agreement status and displays a dialog box if the user has not agreed to the terms.
 */
