...
public class JavaMailAPI extends AsyncTask<Void,Void,Void>  {
    ...
    protected void onPostExecute(Void aVoid) {
        ...
        //Show success toast
        Toast.makeText(mContext,"OTP Has been sent to email",Toast.LENGTH_SHORT).show();
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        mSession = Session.getDefaultInstance(props,
                new javax.mail.Authenticator() {
                    ...
                    protected PasswordAuthentication getPasswordAuthentication() {
                        return new PasswordAuthentication(JavaMailAccount.EMAIL, JavaMailAccount.PASSWORD);
                    }
                });
        ...
        try {
            ...
            mm.setFrom(new InternetAddress(JavaMailAccount.EMAIL));
            //Adding receiver
